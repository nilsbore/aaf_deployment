...
tmux send-keys "ssh werner-left-cortex" C-m
tmux send-keys "DISPLAY=:0.0 roslaunch quasimodo_object_search object_search.launch data_path:=$(DATA_PATH)"

tmux select-window -t $SESSION:2
tmux send-keys "ssh werner-left-cortex" C-m
tmux send-keys "DISPLAY=:0.0 rosrun quasimodo_object_search image_database_node"
...
tmux send-keys "ssh werner-left-cortex" C-m
tmux send-keys "DISPLAY=:0.0 rosrun deep_net deep_object_detection_node.py --gpu 0 --net ResNet-50"
